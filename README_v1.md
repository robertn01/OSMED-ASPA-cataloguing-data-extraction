...
> **New here? Read [`docs/RUNBOOK.md`](docs/RUNBOOK.md)** — the full step-by-step
> for running cataloguing then table/figure extraction on an extended corpus,
> including download, registration, per-pass QC review, calibration, scaling and
> troubleshooting. [`docs/METHOD.md`](docs/METHOD.md) explains the design choices.
...
│   ├── register_pdfs.py              # bulk-add PDFs in data/raw/ to corpus.yaml
...
├── notebooks/
│   └── figure_calibration.ipynb      # Pass 3 calibration walkthrough
├── docs/
